...
//draw the six lines to start the design (atBottomLeft)
canvas.drawAxes()
...
//draw the six lines to start the design (atBottomRight)
...
//draw the six lines to start the design (atTopRight)
