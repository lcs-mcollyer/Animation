...
//            print(nextPoint)
            ...
            // Set the line color
            canvas.lineColor = Color(hue: 350,
                                     saturation: 100,
                                     brightness: 100,
                                     alpha: 100)
            ...
            canvas.fillColor = Color(hue: 350, saturation: 80, brightness: 25, alpha: 0.5)
        canvas.drawRectangle(at: Point(x: -500, y: -500), width: 5000, height: 5000)
